...
export function evaluateHorizon(row: LoggedPrediction, mark: number, evaluatedAt: string): LoggedPrediction {
...
export function horizonHitRate(
  rows: LoggedPrediction[],
): { hits: number; n: number; rate: number; avgTargetError: number } {
